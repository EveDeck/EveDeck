...
public static class ConfigProfileService
{
    ...
    private static readonly string[] AppearanceProperties =
    {
        ...
        nameof(AppSettings.CornerOverlayShowDps),
        nameof(AppSettings.DpsWindowSeconds),
        nameof(AppSettings.DpsShowDamageOut),
        nameof(AppSettings.DpsShowDamageIn),
        nameof(AppSettings.DpsShowLogistics),
        nameof(AppSettings.DpsShowMining),
        nameof(AppSettings.DpsShowLogisticsIn),
        nameof(AppSettings.DpsShowCapTransferOut),
        nameof(AppSettings.DpsShowCapTransferIn),
        nameof(AppSettings.DpsShowNeutOut),
        nameof(AppSettings.DpsShowNeutIn),
        nameof(AppSettings.DpsHideWhenIdle),
        nameof(AppSettings.DpsPanelAnchor),
        nameof(AppSettings.DpsPanelInset),
        nameof(AppSettings.DpsPanelScale),
        nameof(AppSettings.DpsPanelFontFamily),
        nameof(AppSettings.DpsPanelFontSize),
        nameof(AppSettings.DpsPanelTextColor),
        nameof(AppSettings.DpsPanelBold),
        nameof(AppSettings.DpsPanelItalic),
        nameof(AppSettings.DpsPanelDropShadow),
        nameof(AppSettings.DpsPanelOutline),
        nameof(AppSettings.DpsPanelBackgroundColor),
        nameof(AppSettings.DpsPanelBackgroundOpacity),
        nameof(AppSettings.DpsPanelCornerRadius),
