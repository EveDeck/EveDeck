...
// e.g. for "<system> Loki nv EFM-C4 clear", the two mentions are ("<system>", "Loki nv") and
...
public static class IntelSystemTokenizer
{
    ...
    // quotes) without touching characters real system names use internally -- hyphens ("<system>")
