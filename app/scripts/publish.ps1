<#
  ...
  Usage (from anywhere):
    pwsh -NoProfile -ExecutionPolicy Bypass -File P:\EveDeck\app\scripts\publish.ps1
    pwsh -NoProfile -ExecutionPolicy Bypass -File P:\EveDeck\app\scripts\publish.ps1 -RunTests
#>
[CmdletBinding()]
